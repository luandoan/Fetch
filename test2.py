...
class TrajectoryDemo():
    def __init__(self):
        ...
        if reset:
            ...
            arm_goal2  = [1.3, 0.0, 1.5, -1.0, 0.0, -1.0, 1.5]
            #arm_goal[3]  = [0.7, 0.0, 1.7, -0.8, 0.0, -1.0, 1.5]
            #arm_goal[4]  = [0.7, 0.1, 1.7, -0.8, 0.2, -1.0, 1.5]
        ...
        #arm_trajectory.points[3].positions = arm_goal[3]
        #arm_trajectory.points[3].velocities = [0.0 for i in arm_joints]
        #arm_trajectory.points[3].accelerations = [0.0 for i in arm_joints]
        #arm_trajectory.points[3].time_from_start = rospy.Duration(3.0)

        #arm_trajectory.points[4].positions = arm_goal[4]
        #arm_trajectory.points[4].velocities = [0.0 for i in arm_joints]
        #arm_trajectory.points[4].accelerations = [0.0 for i in arm_joints]
        #arm_trajectory.points[4].time_from_start = rospy.Duration(3.0)
